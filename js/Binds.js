...
var PLUGIN_ID = "io.github.chris.rewind"
var SUPER = 64
var SHIFT = 1
var CTRL = 4
var ALT = 8
...
var CANDIDATES = [
    {
        ...
        key: "R",
        desc: "Rewind overlay",
        cmd: "omarchy-shell shell summon io.github.chris.rewind '{}'",
        alternates: [
            { keys: "SUPER + ALT + R", modmask: SUPER + ALT, key: "R" }
        ]
    },
    {
        keys: "SUPER + SHIFT + R",
        ...
        key: "R",
        desc: "Rewind arm",
        cmd: "omarchy-shell io.github.chris.rewind toggleArm '{}'",
        alternates: [
            { keys: "SUPER + ALT + SHIFT + R", modmask: SUPER + SHIFT + ALT, key: "R" }
        ]
    }
]
